...
<form action="<?= base_url('usu/ordem/atualizar')?>" method="post" enctype="multipart/form-data">
    ...
    <div class="row form-group">
        <div class="col-sm-2">
            ...
            <input type="date" class="form-control" name="emissao" value="<?= $ordens[0]->data_emissao?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-sm-2">
            <label for=">Data de Finalização">Data de Finalização: </label>
            <input type="date" class="form-control" name="finalizacao" value="<?= $ordens[0]->data_finalizacao?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-sm-4">
